...
- 성우 배역 프리셋: 내레이터, 다큐멘터리, 뉴스, 선생님, 노인 이야기꾼, 낮은 악역, 빠른 아이 목소리, AI 어시스턴트
- 가족 음성 레지스트리 분석기
...
이 명령은 외부 TTS 엔진을 학습시키는 것이 아닙니다. 가족 음성 레지스트리를 읽고, KVA 엔진 자체가 사용할 네이티브 음성 모델을 만듭니다.
